...
class _AsesorDashboardScreenState extends ConsumerState<AsesorDashboardScreen> {
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            ...
            Expanded(
              child: Text(
                _activeModuleId == null ? 'SIP Fuerza de Ventas' : _getModuleTitle(_activeModuleId!),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: const LinearGradient(
                colors: [AppConstants.colorPrimary, Color(0xFF00c0f8)],
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 4),
                          Text(
                            'Código: $userCode | Agencia SIP Principal',
      ...
      child: Column(
        children: [
          ...
          ListTile(
            ...
            trailing: const Text('SIP Principal', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
          ),
          ListTile(
          ...
          const Text('SIP Mobile Core 360 v2.5.0', style: TextStyle(color: Colors.grey, fontSize: 12)),
        ],
      ),
    );
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              const Text(
                'El cliente abajo firmante autoriza expresamente a la institución SIP a consultar su reporte crediticio consolidado en las centrales de riesgo del Perú (SBS, Equifax, Experian) y realizar la búsqueda en listas internas de prevención de lavado de activos y listas negras.',
  ...
  Widget _buildM8Transmision(AsesorState state) {
    final steps = [
      ...
      'Registrando expediente en Core Financiero...',
