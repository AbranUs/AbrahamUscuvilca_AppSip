...
class _ClientDashboardScreenState extends ConsumerState<ClientDashboardScreen> {
  ...
  Widget _buildBody(
    ...
    switch (_currentIndex) {
      ...
      default:
        return const Center(child: Text('SIP Mobile Core 360'));
    }
  }
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: const LinearGradient(
                colors: [AppConstants.colorPrimary, Color(0xFF0052D4)],
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          const Text('Canal de Banca: App Móvil SIP Core 360', style: TextStyle(fontSize: 16)),
          const Spacer(),
          ElevatedButton(
            onPressed: () {
              ref.read(authProvider.notifier).logout();
